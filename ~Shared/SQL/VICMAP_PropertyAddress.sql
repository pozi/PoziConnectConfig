...
FROM [DSE_VMPROP_PROPERTY] [pr] LEFT OUTER JOIN [DSE_VMADD_ADDRESS] [ad] ON [pr].[PROP_PFI] = [ad].[PR_PFI]  

WHERE [pr].[PR_PTYPE] = 'O' AND [pr].[PV_FTYPE] IN ('5721','5741', '27721', '27741') AND [ad].[IS_PRIMARY] = 'Y'
