select
    ...
    case
        ...
        when blg_unit_id_1 <> '' and blg_unit_id_1 not between 1 and 9999 then 'Invalid: blg_unit_id_1 (' || blg_unit_id_1 || ')'
        ...
        when blg_unit_id_2 <> '' and blg_unit_id_2 not between 1 and 9999 then 'Invalid: blg_unit_id_1 (' || blg_unit_id_1 || ')'
        ...
        when house_number_1 <> '' and house_number_1 not between 1 and 9999 then 'Invalid: blg_unit_id_1 (' || blg_unit_id_1 || ')'
        when length ( house_suffix_1 ) > 2 then 'Invalid: house_suffix_1 (' || house_suffix_1 || ')'
        when length ( house_prefix_1 ) > 2 then 'Invalid: house_prefix_1 (' || house_prefix_1 || ')'
        when house_number_2 <> '' and house_number_1 not between 1 and 9999 then 'Invalid: blg_unit_id_1 (' || blg_unit_id_1 || ')'
