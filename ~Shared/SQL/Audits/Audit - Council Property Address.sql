select
    ...
    case
        ...
        when floor_no_2 <> '' and cast ( floor_no_2 as integer ) not between 1 and 99 then 'Invalid: blg_unit_id_1 (' || blg_unit_id_1 || ')'
        ...
        when house_number_1 <> '' and cast ( house_number_1 as integer ) not between 1 and 99999 then 'Invalid: blg_unit_id_1 (' || blg_unit_id_1 || ')'
        when length ( house_suffix_1 ) > 2 then 'Invalid: house_suffix_1 (' || house_suffix_1 || ')'
        when length ( house_prefix_1 ) > 2 then 'Invalid: house_prefix_1 (' || house_prefix_1 || ')'
        when house_number_2 <> '' and cast ( house_number_1 as integer ) not between 1 and 99999 then 'Invalid: blg_unit_id_1 (' || blg_unit_id_1 || ')'
