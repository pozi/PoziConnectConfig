...
select
    ...
    case when L.plan_desc is null then case
        when override_legal_description like '%ABERFELDY TOWN%' then '5001'
        when override_legal_description like '%BULN BULN TOWN%' then '5129'
        when override_legal_description like '%CHILDERS TOWN%' then '5172'
        when override_legal_description like '%COALVILLE TOWN%' then '5179'
        when override_legal_description like '%COOPERS CREEK TOWN%' then '5193'
        when override_legal_description like '%CROSSOVER TOWN%' then '5213'
        when override_legal_description like '%DARNUM TOWN%' then '5227'
        when override_legal_description like '%DROUIN TOWN%' then '5252'
        when override_legal_description like '%GOULD TOWN%' then '5341'
        when override_legal_description like '%LONGWARRY TOWN%' then '5476'
        when override_legal_description like '%MATLOCK TOWN%' then '5511'
        when override_legal_description like '%NEERIM TOWN%' then '5582'
        when override_legal_description like '%NILMA TOWN%' then '5596'
        when override_legal_description like '%NOOJEE TOWN%' then '5600'
        when override_legal_description like '%ROKEBY TOWN%' then '5679'
        when override_legal_description like '%ST CLAIR TOWN%' then '5693'
        when override_legal_description like '%TOOMBON TOWN%' then '5794'
        when override_legal_description like '%TRAFALGAR TOWN%' then '5800'
        when override_legal_description like '%WALHALLA TOWN%' then '5819'
        when override_legal_description like '%WARRAGUL TOWN%' then '5835'
        when override_legal_description like '%WESTBURY TOWN%' then '5850'
        when override_legal_description like '%WHISKEY CREEK TOWN%' then '5853'
        when override_legal_description like '%WILLOW GROVE TOWN%' then '5862'
        when override_legal_description like '%YARRAGON TOWN%' then '5898'
        when override_legal_description like '%NILMA%' then '5596'
        else ''
