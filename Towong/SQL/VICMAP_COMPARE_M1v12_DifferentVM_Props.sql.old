...
CASE
	...
	CASE
		WHEN DiffVMProps.MultiParcCount > 1 and DiffVMProps.MultiAssCount > 1 THEN (Select PR_PFI from TMP_VM_PROPERTY_PARCEL  where TMP_VM_PROPERTY_PARCEL.parcel_spi = DiffVMProps.SPI)
		ELSE ''
	END AS "property_PFI",

   CASE
      WHEN DiffVMProps.MultiParcCount > 1 and DiffVMProps.MultiAssCount > 1 THEN '' 
