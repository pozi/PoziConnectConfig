...
select distinct
    ...
    case
        ...
        when lpadesc.descr = 'Buffalo Township' then '5124'
        ...
        when lpadesc.descr = 'Kardella Township' then '5407'
        ...
        when lpadesc.descr = 'Port Franklin Township' then '5650'
        when lpadesc.descr = 'Port Welshpool Township' then '5652'
        when lpadesc.descr = 'Sandy Point Township' then '5698'
